...
public class TokenUtil {
	...
	public String getToken(String keyWord) {
		...
		String token = JWT.create().withClaim("timeStamp", System.currentTimeMillis()).withClaim("keyWord", keyWord)
	...
	public Map<String, String> parseToken(String token) {
		...
		Claim keyWord = decodedjwt.getClaim("keyWord");
		map.put("timeStamp", timeStamp.asLong().toString());
		map.put("keyWord", keyWord.asString());
		return map;
	}
}
